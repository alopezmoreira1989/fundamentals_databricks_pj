...
# MAGIC %md
# MAGIC # 10__ingestion / 14__fetch_oracle_statements  ⚠️ EXPERIMENTAL — Tier-A linkbase oracle
# MAGIC
...
# MAGIC consumed by `30__analysis/35__reconcile_filings` (Tier A — coverage / wrong-tag).
# MAGIC
...
# MAGIC
# MAGIC **Scope (v1):** the golden set in `00__config/reconciliation_golden_set.json` (last 10-K +
...
GOLDEN_JSON    = "../00__config/reconciliation_golden_set.json"
...
if SEC_USER_AGENT.strip().lower().startswith("mycompany"):
    print("⚠️  SEC_USER_AGENT looks like the placeholder — SEC will block requests. "
          "Set a real org/email in 00__config/01__tickers.py before running.")
