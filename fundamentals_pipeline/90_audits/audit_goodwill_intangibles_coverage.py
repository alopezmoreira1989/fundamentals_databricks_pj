...
Mirrors the fill-rate pattern of audit_cashflow_coverage.py, scoped to the two Balance
...
Run locally via Databricks Connect (same as test_connection.py):
    python fundamentals_pipeline/90_audits/audit_goodwill_intangibles_coverage.py
"""
