...
Run locally via Databricks Connect (same as test_connection.py):
    python fundamentals_pipeline/90_audits/audit_cashflow_coverage.py

Output: audit_cashflow_coverage_report.md at the repo root.
...
REPORT_PATH = "audit_cashflow_coverage_report.md"
RANDOM_SEED = 42
