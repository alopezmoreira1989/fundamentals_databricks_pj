# 50__publish — dashboard data publish step
...
[../60__frontends/61__streamlit](../60__frontends/61__streamlit) (live at https://alm-equity-fundamentals.streamlit.app/)
...
Both notebooks are wired into `90__pipelines/91__full_pipeline.py` as
...
%run "/Workspace/.../fundamentals_pipeline/50__publish/51__export_dashboard_data"
%run "/Workspace/.../fundamentals_pipeline/50__publish/52__publish_to_github"
```
...
The repo ships with committed synthetic fixtures in `60__frontends/61__streamlit/fixtures/`
...
```bash
databricks fs cp -r dbfs:/Volumes/main/financials/_publish "fundamentals_pipeline/60__frontends/61__streamlit/fixtures/"
```
...
```bash
mkdir -p "fundamentals_pipeline/60__frontends/61__streamlit/fixtures"
cd       "fundamentals_pipeline/60__frontends/61__streamlit/fixtures"
