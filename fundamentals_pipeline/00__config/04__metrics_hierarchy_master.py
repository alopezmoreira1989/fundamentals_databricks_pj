...
# MAGIC %md
# MAGIC # 00__config / 04__metrics_hierarchy_master
# MAGIC
# MAGIC Reads the hierarchy tree from `00__config/metrics_hierarchy.json`, flattens it,
...
# MAGIC 1. Edit `00__config/metrics_hierarchy.json` in the repo
# MAGIC 2. Commit + push
...
HIERARCHY_JSON_PATH = "../00__config/metrics_hierarchy.json"
