...
# MAGIC %md
# MAGIC # 00__config / 03__concept_hierarchy_master
# MAGIC
# MAGIC Reads the hierarchy tree from `00__config/concept_hierarchy.json`, flattens it,
...
# MAGIC 1. Edit `00__config/concept_hierarchy.json` in the repo
# MAGIC 2. Commit + push
